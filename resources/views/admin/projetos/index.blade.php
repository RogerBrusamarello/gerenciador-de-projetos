    ...
    @foreach ($registros as $registro)
        <div class="card">
            <div class="card-body justify-content-center" style="width: 15rem;">
                ...
                <img src="https://www.trzcacak.rs/myfile/detail/487-4878854_ferramentas-em-png-tools-clip-art.png" alt="+" width="120px">
                </a>
                ...
                <div class="float-right">
                    ...
                    &nbsp;
                    <a href="">
                        <img src="https://image.flaticon.com/icons/png/512/70/70388.png" alt="+" width="20px"><br>
                    </a>
                </div>
            </div>
        </div>
