...
<div class="container">
    <h3 class="d-flex justify-content-center">Etapas</h3>
    
    <p class="align-items-center">
        <a class="btn btn-info" href="{{ route('admin.etapas.adicionar') }}">Adicionar Etapas</a>
    </p>
        ...
        <div class="card">
            <div class="card-body justify-content-center" style="width: 15rem;">
                ...
                <div class="float-right">
                    ...
                    <a  href="{{ route('admin.etapas.deletar',$registro->id) }}">
